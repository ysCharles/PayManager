...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        NotificationCenter.default.addObserver(self, selector: #selector(payResult(notification:)), name: NSNotification.Name(rawValue: AlipayResultNotificationKey), object: nil)
    }
